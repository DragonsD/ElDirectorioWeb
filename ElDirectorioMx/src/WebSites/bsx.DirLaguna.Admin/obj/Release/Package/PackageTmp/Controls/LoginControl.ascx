<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs"
    Inherits="bsx.DirLaguna.Admin.Controls.LoginControl" %>
<div class="loginContainer">
    <div id="logoDiv">
        <a href="http://eldirectorio.mx/HomeForm.aspx">
            <img src="../Content/Images/LogoElDirectorio.png" alt="El Directorio" />
        </a>
    </div>
    <div id="login">
        <asp:LoginView ID="LoginView" runat="server">
            <AnonymousTemplate>
                <asp:Login ID="Login" CssClass="cssLogin" runat="server" RememberMeSet="false" UserNameLabelText=""
                            ...
                            <div class="content-box-content">
                                <div class="textUser">
                                    <div class="span-8 last">
                                        <div class="span-8 last">
                                            <asp:Label ID="Label1" runat="server" CssClass="LoginText" AssociatedControlID="UserName">Correo Electrónico</asp:Label>
                                        </div>
                                        <div class="span-8 last textContainer">
                                            <asp:TextBox ID="UserName" runat="server" SkinID="LoginInput" CssClass="LoginInput"
                                ...
                                <div class="textPassword">
                                    <div class="span-8 last">
                                        ...
                                        <div class="span-8 last textContainer">
                                            <asp:TextBox ID="Password" runat="server" SkinID="LoginInput" CssClass="LoginInput"
