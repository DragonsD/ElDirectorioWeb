<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PictureControl.ascx.cs"
    Inherits="bsx.DirLaguna.Admin.Controls.PictureControl" %>
<hr />
<p>
...
<p>
    <div class="span-24 last">
        <div class="SearchButtonContainer">
            <asp:LinkButton ID="SaveButton" runat="server" Text="Guardar" class="button" ValidationGroup="AddItem" />
