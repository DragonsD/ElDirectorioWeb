<%@ Page Title="Cuponeras" Language="C#" MasterPageFile="~/Shared/Normal.master"
    AutoEventWireup="true" CodeBehind="CouponSetDisplay.aspx.cs" Inherits="bsx.DirLaguna.Admin.Core.CouponSetDisplay" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href='<%# CouponDisplayUrl((int)Eval("CouponSetId")) %>'>
                                <asp:Image ID="Image1" ImageUrl="~/App_Themes/Laguna/images/credit-cards.png" ToolTip="Cupones"
                                    runat="server" />
                            </a>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="DeleteImageButton" runat="server" CommandArgument='<%#Eval("CouponSetId") %>'
                                ImageUrl="~/App_Themes/Laguna/images/minus-button.png" ToolTip="Eliminar" CommandName="delCouponSet"
