<%@ Page Title="Cupon" Language="C#" MasterPageFile="~/Shared/Normal.master" AutoEventWireup="true"
    CodeBehind="CouponForm.aspx.cs" Inherits="bsx.DirLaguna.Admin.Core.CouponForm" %>
    ...
    <div class="span-16">
        ...
        <p>
            <div class="span-12 prepend-4 last">
                <asp:CheckBox ID="NationanlCheckBox" runat="server" Text="El cupón es nacional" Visible="false" Checked="false"/>
                <br />
                <asp:CheckBox ID="ClubMemberCheckBox" runat="server" Text="Es Miembro del Club" />
            </div>
        </p>
        <div class="clear">
            <br />
