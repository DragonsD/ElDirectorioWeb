...
{
    public partial class AdYourSelfPage : SimpleFormPage<GeneralSetUp>
    {
        ...
        {
            get { return Navigation.AdYourSelfPage; }
        }
        ...
        {
            this.PreContent = source.AdvertiserMarkup;
        }

        public override bool SaveMethod()
        {
            GeneralSetUpController con = new GeneralSetUpController();
            return con.SaveAdYourSelfContent(this.PreContent);
        }
