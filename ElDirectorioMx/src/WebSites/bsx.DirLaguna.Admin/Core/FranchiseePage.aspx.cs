...
{
    public partial class FranchiseePage : SimpleFormPage<GeneralSetUp>
    {
        ...
        {
            get { return Navigation.FranchiseePage; }
        }
        ...
        {
            this.PreContent = source.FranchiseeMarkup;
        }

        public override bool SaveMethod()
        {
            GeneralSetUpController con = new GeneralSetUpController();
            return con.SaveFranchiseeContent(this.PreContent);
        }
