<%@ Page Title="Galerias" Language="C#" MasterPageFile="~/Shared/Normal.master" AutoEventWireup="true"
    CodeBehind="GalleryDisplay.aspx.cs" Inherits="bsx.DirLaguna.Admin.Core.GalleryDisplay" %>
    ...
    <div class="span-24 last">
        <asp:GridView ID="GalleriesGridView" runat="server" AutoGenerateColumns="False" DataSourceID="GalleryObjectDataSource"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href='<%# PictureDisplay((int)Eval("GalleryId"), (int)Eval("AdvertiserId")) %>'>
                            <asp:Image ID="OfficeImage" ImageUrl="~/App_Themes/Laguna/images/camera--plus.png"
                                ToolTip="Imagenes" runat="server" />
                        </a>
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="EditImageButton" runat="server" CommandArgument='<%#Eval("GalleryId") %>'
                            ImageUrl="~/App_Themes/Laguna/images/pencil.png" CommandName="editGallery" CausesValidation="false"
                            ToolTip="Modificar" />
                    </ItemTemplate>
                    <ItemStyle Width="20px" />
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="DeleteImageButton" runat="server" CommandArgument='<%#Eval("GalleryId") %>'
                            ImageUrl="~/App_Themes/Laguna/images/minus-button.png" CommandName="delGallery"
                            CausesValidation="false" ToolTip="Eliminar" OnClientClick="return confirm('Estas seguro que deseas Eliminar esta galeria?');" />
                    </ItemTemplate>
                    <ItemStyle Width="20px" />
                </asp:TemplateField>
            </Columns>
