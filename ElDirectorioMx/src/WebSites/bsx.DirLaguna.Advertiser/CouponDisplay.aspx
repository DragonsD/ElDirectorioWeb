<%@ Page Title="Cupones" Language="C#" MasterPageFile="~/Shared/Admin.Master" AutoEventWireup="true" CodeBehind="CouponDisplay.aspx.cs" Inherits="bsx.DirLaguna.Advertiser.CouponDisplay" %>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="DeleteImageButton" runat="server" CommandArgument='<%#Eval("CouponId") %>'
                                ImageUrl="~/Content/css2/img/minus-button.png" ToolTip="Eliminar" CommandName="delCoupon"
