...
namespace bsx.DirLaguna.Advertiser
{
    public partial class CouponDisplay : SimpleDisplayPage
    {
        ...
        public string CouponFormUrl(int id) { return string.Format(id <= 0 ? "{0}?{1}={2}" : "{0}?{1}={2}&{3}={4}", this.ResolveUrl(Navigation.CouponForm), QueryKeys.CouponSetId, this.CouponSetId, QueryKeys.CouponId, id); }
