<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginControl.ascx.cs" Inherits="bsx.DirLaguna.Advertiser.Controls.LoginControl" %>
<div class="loginContainer">
    <div id="login">
        <asp:LoginView ID="LoginView" runat="server">
            <AnonymousTemplate>
                <asp:Login ID="Login" CssClass="cssLogin" runat="server" RememberMeSet="false" UserNameLabelText=""
                    FailureText="No se ha podio iniciar sesion" 
                    CreateUserUrl='~/AccountForm.aspx' PasswordRecoveryText="Olvidé mi contraseña"
...
<%--                                    <div class="recoverPass ButtonContainer">
            ...
            <LoggedInTemplate>
                <ul class="loggedIn">
                    <li>
                        <asp:HyperLink NavigateUrl='~/AccountForm.aspx' CssClass="startLink" ID="InicioHyperLink"
