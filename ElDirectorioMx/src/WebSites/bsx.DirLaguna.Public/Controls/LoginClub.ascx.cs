...
{
    public partial class LoginClub : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Page.User.Identity.IsAuthenticated)
            {
                ...
                link.NavigateUrl = this.ResolveUrl(Navigation.CouponDisplayDirectorio);
        ...
        protected void Login_LoggedIn(object sender, EventArgs e)
        {
            ...
            this.Response.Redirect(this.ResolveUrl(Navigation.CouponDisplayDirectorio));
            this.Response.End();
        }
