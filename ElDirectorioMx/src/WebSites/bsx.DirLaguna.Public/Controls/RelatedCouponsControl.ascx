<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RelatedCouponsControl.ascx.cs"
    Inherits="bsx.DirLaguna.Public.Controls.RelatedCouponsControl" %>
...
<asp:DataList ID="CouponsDataList" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
    <ItemTemplate>
        <div class="span-4 smallCouponItem">
