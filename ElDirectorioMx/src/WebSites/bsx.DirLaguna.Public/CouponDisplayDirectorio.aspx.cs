...
{
    public partial class CouponDisplayDirectorio : PublicBasePage
    {
        ...
        {
            base.OnLoad(e);
            this.Title = "Promociones de Club El Directorio";
            this.CatCtrl1.CategorySelected += new EventHandler<Dal.Arguments.IntEventArgs>(CatCtrl1_CategorySelected);
            this.ddlCityCouponFilter.DataBound += new EventHandler(ddlCityCouponFilter_DataBound);
            this.PreRender += new EventHandler(CouponDisplayDirectorio_PreRender);
            ...
            if (!this.IsPostBack && this.AdvertiserId > 0)
            {
                ...
                this.Title = string.Format("Promocion de {0}", adv.Name);
        ...
        void ddlCityCouponFilter_DataBound(object sender, EventArgs e)
        {
            this.ddlCityCouponFilter.Items.Insert(0, new ListItem("Todas las ciudades", "0"));
        }

        void CouponDisplayDirectorio_PreRender(object sender, EventArgs e)
        {
        ...
        void CheckMemberCouponClub(string userName)
        {
            ...
            if (guest.Folio != null)
            {
                this.CouponsCtrl1.Visible = true;
            ...
            else
            {
                ...
                this.btnFilterCityCoupon.Visible = false;
                this.ddlCityCouponFilter.Visible = false;
                this.ddlCityCouponFilter.SelectedIndex = 0;
            }
        }
        ...
        protected void btnFilterCityCoupon_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Redirect(string.Format("{0}?{1}={2}", this.ResolveUrl(Navigation.CouponDisplayDirectorio), QueryKeys.CityId, this.ddlCityCouponFilter.SelectedValue));
        }
    }
}