...
namespace bsx.DirLaguna.Dal.PublicContent
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DirLagunaPublic")]
	public partial class DirLagunaPublicModelDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteGuest(Guest instance);
		...
		public DirLagunaPublicModelDataContext() : 
				base(global::bsx.DirLaguna.Dal.Properties.Settings.Default.ElDirectorioDbConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DirLagunaPublicModelDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DirLagunaPublicModelDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DirLagunaPublicModelDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DirLagunaPublicModelDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCommentChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_Membership_Guest", Storage="_Guest", ThisKey="UserId", OtherKey="UserId")]
	...
	public partial class Guest : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<short> _BornYear;
    ...
    partial void OnUserIdChanging(System.Guid value);
    partial void OnUserIdChanged();
    partial void OnSendPublicityChanging(bool value);
    partial void OnSendPublicityChanged();
    ...
    partial void OnBornYearChanging(System.Nullable<short> value);
    ...
    partial void OnAgeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SendPublicity", DbType="Bit NOT NULL")]
		public bool SendPublicity
		{
			get
			{
				return this._SendPublicity;
			}
			set
			{
				if ((this._SendPublicity != value))
				{
					this.OnSendPublicityChanging(value);
					this.SendPropertyChanging();
					this._SendPublicity = value;
					this.SendPropertyChanged("SendPublicity");
					this.OnSendPublicityChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BornYear", DbType="SmallInt")]
		public System.Nullable<short> BornYear
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_Membership_Guest", Storage="_aspnet_Membership", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public aspnet_Membership aspnet_Membership
		{
			get
			{
